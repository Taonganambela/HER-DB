		...
		<div className="dark:bg-bkgSecondary dark:text-content h-content p-8 w-full">
			...
			<div className="bg-white rounded-md dark:bg-slate-900">
				...
				<div className="flex justify-evenly dark:bg-slate-900">
					...
					<h2 className="flex-[0.5] text-center py-2 text-slate-600 dark:text-slate-300 flex-wrap p-1 border-r border-r-gray-300">
						<input
							type="text"
							className="w-[400px] h-10 border-none outline-none focus:none text-gray-600 dark:text-gray-500 font-semibold dark:bg-slate-900"
				...
				<div className="bg-green-600 text-white text-md py-2 font-semibold flex w-full justify-evenly">
					<h2 className=" text-center  p-1 ">Questonnaire Answers</h2>
				</div>
					...
					<h2 className="pl-10 block border-b border-b-gray-300 dark:border-b-white w-full text-left py-2 text-slate-600 dark:text-slate-300  p-1 border-r border-r-gray-300">
						...
						<span>
							<input
								type="text"
								className="w-[400px] h-10 border-none outline-none focus:none text-gray-600 dark:text-gray-500 font-semibold dark:bg-slate-900"
								placeholder="e.g. the enviroment"
                value={formData.mostStisfying}
								onChange={(e) => {
									const newObj = {
										...formData,
										mostStisfying: e.target.value,
									};
									setFormData(newObj);
								}}
								required
              ...
              onChange={(e) => {
                const newObj = {
                  ...formData,
                  mostFrustrating: e.target.value,
                };
                setFormData(newObj);
              }}
              required
								type="text"
								className="w-[400px] h-10 border-none outline-none focus:none text-gray-600 dark:text-gray-500 font-semibold dark:bg-slate-900"
								placeholder="e.g.I did not have leave days"
							/>
						</span>
					</h2>
					<h2 className="pl-10 block border-b border-b-gray-300 dark:border-b-white w-full text-left py-2 text-slate-600 dark:text-slate-300  p-1 border-r border-r-gray-300">
						4.Kindly high any company policies or procedures that
				...
				<div className="flex justify-evenly dark:bg-slate-900">
					<h2 className="pl-10 block border-b border-b-gray-300 dark:border-b-white w-full text-left py-2 text-slate-600 dark:text-slate-300  p-1 border-r border-r-gray-300">
						5.Would you consider returning to this company in the
						future?
						<br />
						ans:{" "}
						<span>
							...
							<input
								type="text"
								className="w-[400px] h-10 border-none outline-none focus:none text-gray-600 dark:text-gray-500 font-semibold dark:bg-slate-900"
								placeholder="e.g. Maybe when you revise polices"
                value={formData.considering}
								onChange={(e) => {
									const newObj = {
										...formData,
										considering: e.target.value,
									};
									setFormData(newObj);
								}}
								required
					...
					<h2 className="pl-10 block border-b border-b-gray-300 dark:border-b-white w-full text-left py-2 text-slate-600 dark:text-slate-300  p-1 border-r border-r-gray-300">
						6.Would you recommend this company to collegues as a
						good place to work?
						<br />
						ans:{" "}
						<span>
							...
							<input
								type="text"
								className="w-[400px] h-10 border-none outline-none focus:none text-gray-600 dark:text-gray-500 font-semibold dark:bg-slate-900"
								placeholder="e.g. Yes, Definately"
                value={formData.companyRecomendation}
								onChange={(e) => {
									const newObj = {
										...formData,
										companyRecomendation: e.target.value,
									};
									setFormData(newObj);
								}}
								required
				...
				<div className="flex justify-evenly dark:bg-slate-900">
					<h2 className="pl-10 block border-b border-b-gray-300 dark:border-b-white w-full text-left py-2 text-slate-600 dark:text-slate-300  p-1 border-r border-r-gray-300">
						7.Is there anything the company could have done to
						prevent you from leaving?
						<br />
						ans:{" "}
						<span>
							<input
              value={formData.PreventYouFromleaving}
              onChange={(e) => {
                const newObj = {
                  ...formData,
                  PreventYouFromleaving: e.target.value,
                };
                setFormData(newObj);
              }}
              required
					...
					<h2 className="font-semibold pl-10 block border-b border-b-gray-300 dark:border-b-white w-full text-left py-2 text-slate-600 dark:text-slate-300  p-1 border-r border-r-gray-300">
						...
						<span className="font-normal ">
							...
							<input
								type="text"
								className="w-[400px] h-10 border-none outline-none focus:none text-gray-600 dark:text-gray-500 font-semibold dark:bg-slate-900"
								placeholder="e.g.i just want to stop"
					...
					<h2 className="font-semibold text-center text-gray-600 dark:text-white  p-1 ">
						...
						<span>
							<input
								type="text"
								className="w-[400px] h-10 border-none outline-none focus:none text-gray-600 dark:text-gray-500 font-semibold dark:bg-slate-900"
								placeholder="e.g.hehehe, wish i fired you first"
