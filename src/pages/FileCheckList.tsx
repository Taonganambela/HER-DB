...
function FileCheckList() {
	...
	const [tasks, setTasks] = useState<string[]>([
		...
		"Job Offer Letter and Acceptance Letter",
		"Employment Contract",
		"Vital Statistics Form",
		"Copies Professional/Academic Certificates or Transcripts",
		"Copy of NRC/Passport",
		"Pre-Employment Medical Form",
		"Police Clearance Report",
		"Certified Copy of Drivers Licence (FOR JOBS WHERE DRIVING IS REQUIRE)",
		"Banking Details Form",
		"Confirmation Assessment Form and Confirmation Letter",
		"Oath of Secrecy Form",
		"Disclosure of Interest Form",
		"Passport Size Photos",
		"Record of Disciplinary Action (if applicable)",
		"Leave Forms",
		"Salary Advance Forms (if applicable)",
		"Commendations/Awards (if applicable)",
		"Transfer Form (if applicable)",
		"Exit Interview Form (FOR FORMER EMPLOYEES ONLY)",
	]);
